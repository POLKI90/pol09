...
const CELEBRATIONS = [
  ...
  { id: 2,  cost: 10, name: 'CONFETTI BURST',     tier: 'starter',   emojis: ['&#127881;', '&#127882;'],                         count: 10, dur: 1.0 },
  { id: 3,  cost: 12, name: 'SPARKLE SHOWER',     tier: 'starter',   emojis: ['&#10024;'],                                       count: 12, dur: 1.0 },
  { id: 4,  cost: 15, name: 'STAR STORM',         tier: 'starter',   emojis: ['&#11088;'],                                       count: 12, dur: 1.1 },
  { id: 5,  cost: 18, name: 'WINTER FROST',       tier: 'cool',      emojis: ['&#10052;'],                                       count: 16, dur: 1.3 },
  { id: 6,  cost: 20, name: 'RAINBOW BLAST',      tier: 'cool',      emojis: ['&#127752;', '&#10024;'],                          count: 12, dur: 1.1, rainbow: true },
  { id: 7,  cost: 22, name: 'BUBBLE POP',         tier: 'cool',      emojis: ['&#129767;'],                                      count: 14, dur: 1.2 },
  { id: 8,  cost: 25, name: 'NEON FIREWORKS',     tier: 'cool',      emojis: ['&#127878;', '&#10024;'],                          count: 12, dur: 1.2, flash: true },
  { id: 9,  cost: 28, name: 'GOLD RAIN',          tier: 'rare',      emojis: ['&#129689;', '&#128176;'],                         count: 14, dur: 1.2 },
  { id: 10, cost: 30, name: 'HEART EXPLOSION',    tier: 'rare',      emojis: ['&#128150;'],                                      count: 14, dur: 1.1 },
  { id: 11, cost: 33, name: 'ICE STORM',          tier: 'rare',      emojis: ['&#129482;', '&#10052;'],                          count: 16, dur: 1.3, shake: true },
  { id: 12, cost: 35, name: 'PARTY CANNON',       tier: 'rare',      emojis: ['&#127881;', '&#128165;'],                         count: 16, dur: 1.2, shake: true },
  { id: 13, cost: 38, name: 'THUNDER STRIKE',     tier: 'rare',      emojis: ['&#9889;'],                                        count: 14, dur: 0.9, flash: true, shake: true },
  { id: 14, cost: 40, name: 'MONEY SHOWER',       tier: 'rare',      emojis: ['&#128176;', '&#129689;'],                         count: 18, dur: 1.3 },
  { id: 15, cost: 45, name: 'LAVA ERUPTION',      tier: 'epic',      emojis: ['&#128293;'],                                      count: 18, dur: 1.3, epic: true, shake: true },
  { id: 16, cost: 48, name: 'DIAMOND RAIN',       tier: 'epic',      emojis: ['&#128142;'],                                      count: 18, dur: 1.3, epic: true },
  { id: 17, cost: 50, name: 'ROCKET LAUNCH',      tier: 'epic',      emojis: ['&#128640;', '&#10024;'],                          count: 14, dur: 1.4, epic: true, shake: true, flash: true },
  { id: 18, cost: 55, name: 'PHOENIX FIRE',       tier: 'epic',      emojis: ['&#128293;', '&#129413;'],                         count: 20, dur: 1.4, epic: true },
  { id: 19, cost: 58, name: 'GALAXY BURST',       tier: 'epic',      emojis: ['&#127756;', '&#11088;', '&#10024;'],              count: 20, dur: 1.4, epic: true, rainbow: true },
  { id: 20, cost: 62, name: 'VOLCANO FURY',       tier: 'legendary', emojis: ['&#127755;', '&#128293;'],                         count: 22, dur: 1.4, mega: true, shake: true, flash: true },
  { id: 21, cost: 65, name: 'LEGENDARY CROWN',    tier: 'legendary', emojis: ['&#128081;', '&#10024;', '&#11088;'],              count: 24, dur: 1.5, mega: true, rainbow: true, waves: 2 },
  { id: 22, cost: 70, name: 'ULTIMATE MEGA BLAST', tier: 'legendary', emojis: ['&#127881;', '&#127878;', '&#128165;', '&#10024;'], count: 26, dur: 1.5, mega: true, rainbow: true, shake: true, flash: true, waves: 2 },
];
